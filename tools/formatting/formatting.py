...
# 2024-08-03     Evlers       添加LGT和Evlers的版权信息以及删除注释和大括号的处理
...
#搜索Real-Thread/RT-Thread/Evlers/LGT版权信息的截至年份修改至今年 
def change_rtt_copyright_year(line):
    ...
    if re.search("Copyright", line, re.IGNORECASE) \
        and ('Real-Thread' in line or 'RT-Thread' in line or 'Evlers' in line or 'LGT' in line):
