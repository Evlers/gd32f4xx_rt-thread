...
#ifndef CFG_PPP_USING_PUBLIC_APN
#define PPP_APN_CMD          "AT+CGDCONT=1,\"IP\","CFG_PPP_PRIVATE_APN
#else
#ifdef  CFG_PPP_APN_CMCC
#define PPP_APN_CMD          "AT+CGDCONT=1,\"IP\",\"CMNET\""            /* China Mobile Communication Company */
#endif
#ifdef  CFG_PPP_APN_CUCC
#define PPP_APN_CMD          "AT+CGDCONT=1,\"IP\",\"UNINET\""           /* China Unicom Communication Company */
#endif
#ifdef  CFG_PPP_APN_CTCC
